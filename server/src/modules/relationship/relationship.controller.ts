...
import { createRelationshipSchema, updateRelationshipSchema } from "./relationship.schema";
...
export async function create(req: Request, res: Response, next: NextFunction) {
  try {
    const input = createRelationshipSchema.parse({ ...req.body, projectId: req.params.projectId });
